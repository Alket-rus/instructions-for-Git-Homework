...
git init
```
# Создания коммитов [Основы Git - Создание Git-репозитория]("https://git-scm.com/book/ru/v2/Основы-Git-Создание-Git-репозитория" "Ссылка на статью")
...
```
# Работа с состояниями [Основы Git - Запись изменений в репозиторий]("https://git-scm.com/book/ru/v2/Основы-Git-Запись-изменений-в-репозиторий" "Ссылка на статью")
